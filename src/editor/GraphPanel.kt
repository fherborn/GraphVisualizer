...
class  GraphPanel : JPanel(), MouseListener, MouseMotionListener {
    ...
    fun startAlgo(algo: ToolBar.Algo, stepped: Boolean, stepTime: Int) {
        val start = startNode
        val end = endNode
    ...
    fun resetAlgo(algo: ToolBar.Algo) {
        pathFinder?.stop()
